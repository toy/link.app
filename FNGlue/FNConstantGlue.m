...
+ (id)constantWithCode:(OSType)code_ {
    switch (code_) {
        ...
        case 'bpnl': return [self BurningPanel];
        ...
        case 'minl': return [self MoreInfoPanel];
        ...
        case 'shnl': return [self SimpleHeaderPanel];
...
+ (FNConstant *)BurningPanel {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"BurningPanel" type: typeEnumerated code: 'bpnl'];
    return constantObj;
}
...
+ (FNConstant *)MoreInfoPanel {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"MoreInfoPanel" type: typeEnumerated code: 'minl'];
    return constantObj;
}
...
+ (FNConstant *)SimpleHeaderPanel {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"SimpleHeaderPanel" type: typeEnumerated code: 'shnl'];
    return constantObj;
}
